...
const API_ROOT = 'https://ybsczxf35c.execute-api.eu-west-1.amazonaws.com'; // CHANGE THIS TO MATCH THE URL OF YOUR API GATEWAY API OR YOUR CUSTOM DOMAIN FOR API
